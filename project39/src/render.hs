...
buttonsAndFields ([],(x,y)) = [Color white (Translate 150 37 (fromOperators "+")),
                               ...
                               Color white (Translate (-250) (-87) (Text "x")),
                               Color white (Translate (-240) (-207) (Text ".")),
                               Color white (Translate (-245) (-327) (Text "0")),
...
buttonsAndFields (a,(x,y))
                              | length a > 12 = [Color white (Translate 150 37 (fromOperators "+")),
                               Color white (Translate 150 (-87) (fromOperators "-")),
                               Color white (Translate 150 (-207) (fromOperators "/")),
                               Color white (Translate 150 (-327) (fromOperators "=")),
                               Color white (Translate 50 37 (fromOperators "*")),
                               ...
                               Color white (Translate (-200) (-280) (rectangleWire 100 120)),
                               Color white (Translate x (0+250) (rectangleWire  1000 175)),
                               Color white (Translate (-500 - shiftCoordinates a) (0+200) (Text a))]
                              | otherwise = [Color white (Translate 150 37 (fromOperators "+")),
                                             Color white (Translate 150 (-87) (fromOperators "-")),
                                             Color white (Translate 150 (-207) (fromOperators "/")),
                                             Color white (Translate 150 (-327) (fromOperators "=")),
                                             Color white (Translate 50 37 (fromOperators "*")),
                                             ...
                                             Color white (Translate (-200) (-280) (rectangleWire 100 120)),
                                             Color white (Translate x (0+250) (rectangleWire  1000 175)),
                                             Color white (Translate (x-500)(0+200) (Text a))]
...
shiftCoordinates string = read (show ((77 * (length (drop 12 string))))) :: Float
